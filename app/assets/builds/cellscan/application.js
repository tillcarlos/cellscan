...
%o`, message, error2, detail);
  ...
  var filter_checkboxes_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(dropdown_controller_default, "targets", ["dropdown", "icon", "button"]);

  // app/javascript/controllers/search_select_controller.js
  var search_select_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(search_select_controller_default, "targets", ["id", "input", "dropdown", "item"]);

  // app/javascript/controllers/index.js
  application.register("debounce", debounce_controller_default);
  application.register("filter-checkboxes", filter_checkboxes_controller_default);
  application.register("dropdown", dropdown_controller_default);
  application.register("search-select", search_select_controller_default);
})();
